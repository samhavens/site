...
With 30,000 draws ending in 2026, the corrected default gives a retained median of **6.8%**, with a middle 90% range of **5.3%–9.2%**. Applying the old timing rule to the same input draws gives **8.1%**, with a range of **6.1%–11.9%**. Each version applies its own feasibility screen. These are sensitivity results under the stated assumptions, not population confidence intervals.
